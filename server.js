...
app.post("/upload", upload.single("video"), async (req, res) => {
  ...
  try {
    ...
    const auth = new google.auth.GoogleAuth({
      keyFile: "video-testimonial-tool-423310-c630d297dbe5.json", // Path to the service account key file
    ...
    const fileMetadata = {
      ...
      parents: ["1ITXURqV1hp2xePdy_soSFBZTsNZfWLNa"], // Parent folder ID in Google Drive
    };
    const media = {
